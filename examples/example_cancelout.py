...
import numpy as np
import pandas as pd
from pystreamfs.fs_algorithms import cancelout
...
# Plot statistics
stream_simulator.plot_stats(stats, feature_names, 'CancelOut', type(model).__name__, metric.__name__, param).show()
