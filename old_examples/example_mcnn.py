...
import numpy as np
import pandas as pd
from pystreamfs.fs_algorithms import mcnn
...
# Plot statistics
stream_simulator.plot_stats(stats, feature_names, 'Micro Cluster Nearest Neighbor (MCNN)', type(model).__name__, metric.__name__, param).show()
